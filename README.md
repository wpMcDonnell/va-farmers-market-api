...
1. Rename the directory from va-farmers-market-api -> your-app-name.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Move into the new project and `git init`.
1. Replace all instances of `'va-farmers-market-api'` with your app name.
